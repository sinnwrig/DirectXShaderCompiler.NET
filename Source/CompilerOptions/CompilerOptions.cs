...
/// <summary> The floating-point denormal behavior DXC should use </summary>
public enum DenormalType
{
    /// <summary> Any behavior is allowed </summary>
    Any,

    /// <summary> Preserve denormal input/output </summary>
    Preserve,

    /// <summary> Denormal input/output should be flushed to zero </summary>
    Ftz
}
...
public partial class CompilerOptions
{
    ...
    public bool rootSignatureDefine = false;
    ...
    /// <summary> Defines packing mode (column or row major) of matrices </summary>
